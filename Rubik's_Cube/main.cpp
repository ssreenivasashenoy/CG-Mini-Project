...
int main(int argc, char **argv)
{
    ...
    glutAddMenuEntry("Top Reverse:q", 2);
    glutAddMenuEntry("Right :s", 3);
    glutAddMenuEntry("Right Reverse:w", 4);
    glutAddMenuEntry("Front :d", 5);
    glutAddMenuEntry("Front Reverse:e", 6);
    glutAddMenuEntry("Left :f", 7);
    glutAddMenuEntry("Left Reverse:r", 8);
    glutAddMenuEntry("Back :g", 9);
    glutAddMenuEntry("Back Reverse:t", 10);
    glutAddMenuEntry("Bottom :h", 11);
    glutAddMenuEntry("Bottom Reverse:y", 12);
